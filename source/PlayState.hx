...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['NEVER GONNA GIVE YOU UP', 0.2], //From 0% to 19%
		['You cant play?', 0.4], //From 20% to 39%
		['Huh?', 0.5], //From 40% to 49%
		['Sheeesh', 0.6], //From 50% to 59%
		['Huh', 0.69], //From 60% to 68%
		['Good', 0.7], //69%
		['Normal', 0.8], //From 70% to 79%
		['Hmmm', 0.9], //From 80% to 89%
		['Kinda like hacker', 1], //From 90% to 99%
		['WHAT THE FUCK DUDE', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
        ...
        creditText.text = 'PORTED BY SHIGGY;
